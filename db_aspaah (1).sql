...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2021 a las 22:12:46
...
CREATE TABLE `distritos` (
  ...
  `name` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provincia_id` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  `departamento_id` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `hijos` (
  ...
  `fechnac` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `intruccion` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(6, '2021_12_03_171931_create_sessions_table', 1),
(7, '2021_12_04_155713_create_personas_table', 1),
(8, '2021_12_04_155727_create_departamentos_table', 1),
(9, '2021_12_04_155728_create_provincias_table', 1),
(10, '2021_12_04_155729_create_distritos_table', 1),
(11, '2021_12_04_155730_create_socios_table', 1),
(12, '2021_12_04_155810_create_usuarios_table', 1),
(13, '2021_12_04_155821_create_hijos_table', 1);
...
CREATE TABLE `personas` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ape_paterno` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ape_materno` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dni` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fe_nacimiento` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `es_civil` enum('1','2','3','4') COLLATE utf8mb4_unicode_ci NOT NULL,
  `sexo` enum('1','2') COLLATE utf8mb4_unicode_ci NOT NULL,
  `telefono` varchar(9) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `direccion` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `es_persona` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fa_parentesco` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `personas` (`id`, `nombre`, `ape_paterno`, `ape_materno`, `dni`, `fe_nacimiento`, `es_civil`, `sexo`, `telefono`, `email`, `direccion`, `es_persona`, `fa_parentesco`, `parentesco`, `created_at`, `updated_at`) VALUES
(1, 'Everick', 'Puma', 'Mestas', '72496995', '2002-07-04', '1', '1', '970697466', 'chocopaneton4k@gmail.com', 'Av El Maestro', '1', NULL, NULL, '2021-12-08 00:25:10', '2021-12-08 00:25:10'),
(2, 'Marvin', 'Tito', 'Mestas', '72496995', '1233-03-12', '1', '1', '970697466', 'chocopaneton4k@gmail.com', 'Av El Maestro', '1', NULL, NULL, '2021-12-08 01:06:53', '2021-12-08 01:06:53');
...
('f9Q00D9TTAzc4lxgQf5jgW8C2RgcTRYaRIBaimSl', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36', '', 1638908405);
...
CREATE TABLE `socios` (
  ...
  `categoria` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `es_socio` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `comunidad` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `distrito_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provincia_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `socios` (`id`, `personas_id`, `codigo`, `tipo`, `categoria`, `es_socio`, `comunidad`, `distrito_id`, `provincia_id`, `departamento_id`, `created_at`, `updated_at`) VALUES
(1, 1, '2020', 'Hola', 'Que Hace', '1', 'Buenas', '101101', '202', '14', '2021-12-08 00:46:12', '2021-12-08 01:05:50'),
(2, 2, '1234', 'Socio', 'Hola', '1', 'Comunida1', '211101', '2111', '21', '2021-12-08 01:07:41', '2021-12-08 01:07:41');
...
(1, 'Everick Puma', 'ever1ever14@gmail.com', NULL, '$2y$10$KZtInloB662EKEOqu538tO0uDGnZ9XCZ24mTekXQXZ/Z.uFR9ZCQK', NULL, NULL, NULL, NULL, NULL, '2021-12-08 00:24:50', '2021-12-08 00:24:50');
...
ALTER TABLE `departamentos`
  ADD UNIQUE KEY `departamentos_id_unique` (`id`);

--
-- Indices de la tabla `distritos`
--
ALTER TABLE `distritos`
  ADD UNIQUE KEY `distritos_id_unique` (`id`);
...
ALTER TABLE `hijos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `hijos_personas_id_foreign` (`personas_id`);
...
ALTER TABLE `socios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `socios_personas_id_foreign` (`personas_id`),
  ADD KEY `socios_distrito_id_foreign` (`distrito_id`),
  ADD KEY `socios_provincia_id_foreign` (`provincia_id`),
  ADD KEY `socios_departamento_id_foreign` (`departamento_id`);
...
--
ALTER TABLE `hijos`
  ADD CONSTRAINT `hijos_personas_id_foreign` FOREIGN KEY (`personas_id`) REFERENCES `personas` (`id`);

--
-- Filtros para la tabla `socios`
--
ALTER TABLE `socios`
  ADD CONSTRAINT `socios_departamento_id_foreign` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id`),
  ADD CONSTRAINT `socios_distrito_id_foreign` FOREIGN KEY (`distrito_id`) REFERENCES `distritos` (`id`),
  ADD CONSTRAINT `socios_personas_id_foreign` FOREIGN KEY (`personas_id`) REFERENCES `personas` (`id`),
  ADD CONSTRAINT `socios_provincia_id_foreign` FOREIGN KEY (`provincia_id`) REFERENCES `provincias` (`id`);
COMMIT;
